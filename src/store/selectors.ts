...
export const getSelectedMovieState = (state: AppState): Record<SelectedMovieState> => state.selectedMovie;
...
export const getSearchMoviesTotal = createSelector([getMovies], (movies) => movies.get('total'));
